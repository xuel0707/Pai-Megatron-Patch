...
run_cmd="torchrun $DISTRIBUTED_ARGS pretrain_deepseek.py
 ...
 ${do_option} ${sp_option} ${moe_options} ${offload_option} ${sft_options} ${vp_option} ${packing_options} ${uneven_split_option} ${attn_backend_option} ${mtp_options} 2>&1 | tee ${LOG_FILE}"
